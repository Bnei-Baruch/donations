...
require 'admin_lang_controller'

# Re-raise errors caught by the controller.
class AdminLangController; def rescue_action(e) raise e end; end

class AdminLangControllerTest < Test::Unit::TestCase
  fixtures :languages

  def setup
    @controller = AdminLangController.new
